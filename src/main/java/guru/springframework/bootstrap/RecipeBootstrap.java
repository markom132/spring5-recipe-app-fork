...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a " +
                ...
                "Sprinkle with salt and lime (or lemon) juice. The acid in the lime juice will provide some balance to the richness of the avocado and " +
                "will help delay the avocados from turning brown.\n" + "Add the chopped onion, cilantro, black pepper, and chiles. " +
                "Chili peppers vary individually in their hotness. So, start with a half of one chili pepper and add to the guacamole to " +
        ...
        guacRecipe.setUrl("http://www.simplyrecipes.com/recipes/perfect_guacamoley");
        ...
        tacosRecipe.setDirections("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
                ...
                "Grill the chicken for 3 to 4 minutes per side, or until a thermometer inserted into the thickest part of " +
                "the meat registers 165F. Transfer to a plate and rest for 5 minutes.\n" + "4 Warm the tortillas: " +
                ...
                "place a small handful of arugula. Top with chicken slices, sliced avocado, radishes, tomatoes, and onion slices. " +
        ...
        tacoNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
                ...
                "I can always sniff out a late-night snacker when the aroma of tortillas heating in a hot pan on " +
                "the stove comes wafting through the house.\n" + "Today’s tacos are more purposeful – " +
                "a deliberate meal instead of a secretive midnight snack!\n" + "First, " +
                "I marinate the chicken briefly in a spicy paste of ancho chile powder, oregano, cumin, " +
